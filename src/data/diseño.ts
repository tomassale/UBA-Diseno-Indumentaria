 ...
 * El póster distingue TRES columnas de correlatividad:
 *   a) para CURSAR: los FINALES aprobados de ...
 *   b) para CURSAR: las CURSADAS aprobadas de ...
 *   c) para dar el FINAL: los FINALES aprobados de ...
 * El modelo de datos sólo tiene dos listas, así que (a) y (b) se unifican en
 * `correlativasCursar` (que es como lo interpreta `getEstadoEfectivo`: alcanza con
 * tener la materia regularizada o aprobada) y (c) va en `correlativasFinal`.
 * Consecuencia conocida: la app es un poco más permisiva que el póster para las
 * correlativas de la columna (a), donde en realidad hace falta el final.
 ...
 * ⚠️ El póster escribe "IP-FGM" en las optativas; es una errata suya por FGDM.
 * Correlativas y tipo de cursada verificados celda por celda contra
 * `public/MAPA CARRERA.pdf` (2026-07-30).
 */
...
export const disenoIndumentaria: Carrera = {
  ...
  materias: [
    // ── CBC ──────────────────────────────────────────────────────────────
    { id: 'proyectual1', codigo: 'PROYECTUAL1', nombre: 'Proyectual 1', anio: 'CBC', tieneFinal: false, correlativasCursar: [], correlativasFinal: [], tipo: 'obligatoria' },
    { id: 'proyectual2', codigo: 'PROYECTUAL2', nombre: 'Proyectual 2', anio: 'CBC', tieneFinal: false, correlativasCursar: [], correlativasFinal: [], tipo: 'obligatoria' },
    ...
    { id: 'tpi1', codigo: 'TPI1', nombre: 'TPI1', anio: 2, tieneFinal: true, correlativasCursar: ['TPIN1', 'IP', 'ME1', 'TPIN2'], correlativasFinal: ['TPIN2'], tipo: 'obligatoria' },
    ...
    { id: 'tpi2', codigo: 'TPI2', nombre: 'TPI2', anio: 2, tieneFinal: true, correlativasCursar: ['TPIN1', 'IP', 'ME1', 'TPI1', 'TPIN2'], correlativasFinal: ['TPI1'], tipo: 'obligatoria' },

    // ── 3º Año ───────────────────────────────────────────────────────────
    { id: 'pi2', codigo: 'PI2', nombre: 'Proyecto Indum2', anio: 3, tieneFinal: false, correlativasCursar: ['PI1', 'MP', 'ME2', 'ADIT1', 'HDIT1', 'ME1', 'IP', 'FGDM', 'TPI1'], correlativasFinal: [], tipo: 'obligatoria' },
    { id: 'pi3', codigo: 'PI3', nombre: 'Proyecto Indum3', anio: 3, tieneFinal: false, correlativasCursar: ['PI2', 'PI1', 'TPI1', 'ME2', 'ADIT1', 'HDIT1', 'MP', 'TPI2'], correlativasFinal: [], tipo: 'obligatoria' },
    { id: 'pa1', codigo: 'PA1', nombre: 'Proy Accesorios 1', anio: 3, tieneFinal: false, correlativasCursar: ['PI2', 'PI1', 'MP', 'ME2', 'ME1', 'ADIT1', 'HDIT1', 'TPI1'], correlativasFinal: [], tipo: 'obligatoria' },
    { id: 'socio', codigo: 'SOCIO', nombre: 'Socio', anio: 3, tieneFinal: true, correlativasCursar: ['IP', 'ME1', 'TPIN2', 'ADIT1', 'HDIT1'], correlativasFinal: ['ADIT1', 'HDIT1'], tipo: 'obligatoria' },
    { id: 'cym1', codigo: 'CYM1', nombre: 'CyM1', anio: 3, tieneFinal: true, correlativasCursar: [...TODO_1_ANIO, 'TPI1', 'HDIT2'], correlativasFinal: ['TPI1', 'HDIT2'], tipo: 'obligatoria' },
    { id: 'tpi3', codigo: 'TPI3', nombre: 'TPI3', anio: 3, tieneFinal: true, correlativasCursar: [...TODO_1_ANIO, 'TPI2'], correlativasFinal: ['TPI2'], tipo: 'obligatoria' },
    { id: 'tpi4', codigo: 'TPI4', nombre: 'TPI4', anio: 3, tieneFinal: true, correlativasCursar: [...TODO_1_ANIO, 'TPI3'], correlativasFinal: ['TPI3'], tipo: 'obligatoria' },
    { id: 'cym2', codigo: 'CYM2', nombre: 'CyM2', anio: 3, tieneFinal: true, correlativasCursar: [...TODO_1_ANIO, 'CYM1', 'TPI1', 'HDIT2'], correlativasFinal: ['CYM1', 'TPI1', 'HDIT2'], tipo: 'obligatoria' },
    ...
    // ── 4º Año ───────────────────────────────────────────────────────────
    { id: 'pi4', codigo: 'PI4', nombre: 'Proyecto Indum4', anio: 4, tieneFinal: false, correlativasCursar: ['PI3', 'PI2', 'PI1', 'TPI1', 'TPI2', 'TPI3'], correlativasFinal: [], tipo: 'obligatoria' },
